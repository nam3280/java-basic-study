...
public class ReferenceVariableCompareExample {
  ...
  public static void main(String[] args) {//변수 : 데이터 하나만을 저장하는 상자, 저장해야 할 데이터가 많아지면 변수도 많아진다.
//배열 : 많은 데이터를 효율적으로 관리(CRUD), 연속된 공간에 데이터를 나열시키고 각 데이터에 인덱스를 부여해 놓은 자료 구조
//배열의 인덱스는 0부터 시작하고 대괄호[]를 사용하여 각 항목의 값을 읽거나 저장할 때 사용
//배열의 특징 : 같은 데이터 타입의 값만 관리, 배열은 초기에 길이가 정해진다.(저장공간 변경 불가)
